...
export function ClujContactSection() {
        ...
        >
          ...
          <div className="space-y-8 mt-4">
            <motion.div variants={itemVariants}>
              ...
              <p className="text-lg hover:text-yellow-100 transition-colors cursor-pointer inline-block">hi@startupweekendromania.com</p>
            </motion.div>
            ...
            <motion.div variants={itemVariants}>
              ...
              <div className="flex gap-4">
                <motion.a whileHover={{ scale: 1.15, rotate: -5, backgroundColor: "#fff", color: "#1A1A1B" }} href="https://www.instagram.com/startupweekendromania/" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-full border-2 border-white flex items-center justify-center transition-colors">
                ...
                <motion.a whileHover={{ scale: 1.15, rotate: 5, backgroundColor: "#fff", color: "#1A1A1B" }} href="https://www.linkedin.com/company/techstars-startup-weekend-romania" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-full border-2 border-white flex items-center justify-center transition-colors">
                  <span className="sr-only">LinkedIn</span>
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path fillRule="evenodd" d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" clipRule="evenodd" /></svg>
                </motion.a>
                <motion.a whileHover={{ scale: 1.15, rotate: -5, backgroundColor: "#fff", color: "#1A1A1B" }} href="https://www.facebook.com/TechstarsSWRomania/" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-full border-2 border-white flex items-center justify-center transition-colors">
                  <span className="sr-only">Facebook</span>
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path d="M24 12.073C24 5.405 18.627 0 12 0S0 5.405 0 12.073c0 6.019 4.388 11.008 10.125 11.927v-8.437H7.078v-3.49h3.047V9.413c0-3.018 1.792-4.686 4.533-4.686 1.313 0 2.686.235 2.686.235v2.963h-1.514c-1.491 0-1.956.93-1.956 1.885v2.263h3.328l-.532 3.49h-2.796V24C19.612 23.081 24 18.092 24 12.073Z" /></svg>
                </motion.a>
              </div>
            </motion.div>
          </div>
