        ...
        >
          ...
          <div className="space-y-8 mt-4">
            <motion.div variants={itemVariants}>
              ...
              <p className="text-lg hover:text-yellow-100 transition-colors cursor-pointer inline-block">cluj@startupweekend.ro</p>
            </motion.div>
            ...
            <motion.div variants={itemVariants}>
              ...
              <p className="text-lg hover:text-yellow-100 transition-colors cursor-pointer inline-block">+40 123 456 781</p>
            </motion.div>
            ...
            <motion.div variants={itemVariants}>
              ...
              <p className="text-lg">Tech Hub, Cluj-Napoca</p>
            </motion.div>
