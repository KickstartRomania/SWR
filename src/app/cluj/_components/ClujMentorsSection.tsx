...
const mentors = [
  { name: "Andrei Mureșan", company: "Tech Innovation Lab" },
  { name: "Cristina Popa", company: "Digital Agency Cluj" },
  { name: "Radu Stanciu", company: "Venture Partners" },
  { name: "Laura Dumitru", company: "Product Design Studio" },
  { name: "Bogdan Vasile", company: "Software Development Co." },
  { name: "Ana-Maria Stoica", company: "Growth Marketing" },
];

export function ClujMentorsSection() {
  return (
