export function ClujWhatIsSection() {
  return (
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        <div className="flex flex-col relative z-10">
          ...
          <p className="font-medium text-lg md:text-xl text-foreground/80 leading-relaxed mb-10 max-w-lg">
            Startup Weekend Cluj-Napoca is a high-energy weekend hackathon where builders, creatives, and future founders come together to launch real startup ideas, from pitch to prototype.
          </p>
        </div>
