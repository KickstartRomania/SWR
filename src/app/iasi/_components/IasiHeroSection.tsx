...
export function IasiHeroSection() {
  ...
  return (
    <section className="relative w-full max-w-7xl mx-auto px-6 pt-32 pb-24 md:py-32 flex flex-col items-center text-center overflow-hidden">
      ...
      >
        <Image src="/stickers/pitch-friday.png" alt="Sticker 1" width={250} height={100} className="object-contain w-full h-full" />
      </motion.div>
      ...
      <motion.div
        ...
        className="absolute top-20 right-4 md:top-32 md:right-16 w-24 h-24 md:w-40 md:h-40 flex items-center justify-center z-20 pointer-events-none"
      >
        <Image src="/stickers/pbp.png" alt="Sticker 1" width={250} height={100} />
      </motion.div>
      ...
      >
        <Image src="/stickers/present-judges.png" alt="Sticker 1" width={200} height={200} className="object-contain w-full h-full" />
      </motion.div>
      ...
      >
        <Image src="/stickers/go.png" alt="Let’s go sticker" width={250} height={100} className="object-contain w-full h-full" />
      </motion.div>
      ...
      >
        ...
        <motion.span
          ...
          className="font-hand text-xl md:text-2xl text-foreground/60 mb-8 flex items-center gap-2 rotate-[1deg]"
        >
